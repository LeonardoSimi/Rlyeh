...
public class Projectile_Eye : MonoBehaviour {
    ...
    public ArmoredEyeAI armoredEyeAI;
    ...
    void Start()
    {
        ...
        armoredEyeAI = GameObject.Find("ArmoredEye").GetComponent<ArmoredEyeAI>();
        pLastPos = new Vector3(player.transform.position.x, armoredEyeAI.transform.position.y - 1, armoredEyeAI.transform.position.z);
